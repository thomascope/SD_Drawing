...
for crun = 1:nrun
    ...
    inputs{5, crun} = MATLAB_CODE_TO_FILL_INPUT; % Factorial design specification: Vector - cfg_entry
    inputs{6, crun} = MATLAB_CODE_TO_FILL_INPUT; % Factorial design specification: Explicit Mask - cfg_files
end
spm('defaults', 'PET');
